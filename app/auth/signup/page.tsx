      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="panel relative overflow-hidden p-6 sm:p-8">
          ...
          <div className="mb-7">
            ...
            <h1 className="text-2xl font-semibold tracking-tight">Суралцах орчноо нээ</h1>
            <p className="mt-2 text-sm text-slate-500">Үгийн сан, давталт, ахицаа нэг бүртгэлд хадгална.</p>
          </div>
