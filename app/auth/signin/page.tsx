...
export default function SignInPage() {
  ...
  return (
    <AuthLayout title="Тавтай морил" description="Суралцах орчиндоо нэвтэрнэ үү.">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between">
            ...
            <Link href="/auth/forgot-password" className="mb-[7px] text-xs font-semibold text-[#9a6418] hover:text-[#6f460d]">
              Мартсан уу?
            </Link>
          </div>
